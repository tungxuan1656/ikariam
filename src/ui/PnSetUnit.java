...
//        this.urlImg = urlImg;
    ...
    public void addControls() {
        ...
        sld.setFont(new Font("Tahoma", Font.PLAIN, 17));
        sld.setBounds(200, 15, 300, 26);
        sld.setBackground(new Color(251,232,193));
        this.add(sld);
        
        txt = new JTextField(3);
        txt.setFont(new Font("Tahoma", Font.PLAIN, 14));
        txt.setBounds(520, 15, 45, 26);
        this.add(txt);
        
        btnSetMax = new JButton("Max");
        btnSetMax.setFont(new Font("Tahoma", Font.PLAIN, 14));
        btnSetMax.setBounds(565, 15, 81, 26);
        this.add(btnSetMax);
    }
