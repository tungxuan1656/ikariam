...
public class HouseInfoUI extends JDialog {
    ...
    public void addControls() {
        ...
        lblTitle.setBounds(219, 0, 156, 20);
        ...
        lblLvHou.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblLvHou.setBounds(50, 15, 97, 20);
        pnLvHou.add(lblLvHou);
        sldLevelHouse = new JSlider(0, 40);
        sldLevelHouse.setBounds(180, 12, 300, 26);
        sldLevelHouse.setBackground(new Color(251, 232, 193));
        pnLvHou.add(sldLevelHouse);
        txtLevelHouse = new JTextField(40);
        txtLevelHouse.setFont(new Font("Tahoma", Font.PLAIN, 14));
        txtLevelHouse.setBounds(500, 12, 30, 26);
        ...
        lblTypeOfHou.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblTypeOfHou.setBounds(50, 15, 90, 20);
        pnTypeOfHou.add(lblTypeOfHou);
        cbo = new JComboBox<>();
        cbo.setFont(new Font("Tahoma", Font.PLAIN, 14));
        cbo.setBounds(160, 12, 200, 26);
        ...
        JLabel lblNameHouse = new JLabel("Name");
        lblNameHouse.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblNameHouse.setBounds(401, 18, 46, 14);
        pnTypeOfHou.add(lblNameHouse);
        
        tfNameHouse = new JTextField();
        tfNameHouse.setFont(new Font("Tahoma", Font.PLAIN, 14));
        tfNameHouse.setBounds(461, 12, 112, 26);
        pnTypeOfHou.add(tfNameHouse);
        tfNameHouse.setColumns(10);
        ...
        btnBarrack.setFont(new Font("Tahoma", Font.PLAIN, 14));
        btnBarrack.setBounds(50, 350, 115, 30);
        btnBarrack.setBackground(new Color(248, 222, 164));
        pnMain.add(btnBarrack);

        btnBattleFighting = new JButton("Fighting");
        btnBattleFighting.setFont(new Font("Tahoma", Font.PLAIN, 14));
        btnBattleFighting.setBounds(50, 395, 115, 30);
        btnBattleFighting.setBackground(new Color(248, 222, 164));
        pnMain.add(btnBattleFighting);

        btnUpgradeUnit = new JButton("Upgrade Unit");
        btnUpgradeUnit.setFont(new Font("Tahoma", Font.PLAIN, 14));
        btnUpgradeUnit.setBounds(50, 440, 115, 30);
...
//        IsLandUI.currentTextField.setText(IsLandUI.currentHouse.getName());
        if (IsLandUI.currentHouse.getTypeOfHouse()!=3) {
        	if (tfNameHouse.getText().length() < 10) {
            	if (IsLandUI.currentHouse.getName().equals("")) {
            		IsLandUI.currentHouse.setName(tfNameHouse.getText());
            		IsLandUI.currentTextField.setText(tfNameHouse.getText());
            	}
            }
            else {
            	if (IsLandUI.currentHouse.getName().equals("")) {
            		IsLandUI.currentTextField.setText(tfNameHouse.getText().substring(0, 9));
            		IsLandUI.currentHouse.setName(tfNameHouse.getText().substring(0, 9));
            	}
            }
        }
    ...
    private void setIconHouse() {
        if (IsLandUI.currentHouse.getLevelOfHouse() == 1) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv1E.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 2 && IsLandUI.currentHouse.getLevelOfHouse() <= 3) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv2E.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 4 && IsLandUI.currentHouse.getLevelOfHouse() <= 6) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv4E.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 7 && IsLandUI.currentHouse.getLevelOfHouse() <= 9) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv7E.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 10 && IsLandUI.currentHouse.getLevelOfHouse() <= 12) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv10E.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 13 && IsLandUI.currentHouse.getLevelOfHouse() <= 15) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv13E.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() == 16 || IsLandUI.currentHouse.getLevelOfHouse() == 17) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv16E.PNG")));
        }
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 18) {
            IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv18+E.PNG")));
        }
    }
    ...
    public void showWindow() {
        ...
        this.setModal(true);
        tfNameHouse.setText(IsLandUI.currentHouse.getName());
