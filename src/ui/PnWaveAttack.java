...
public class PnWaveAttack extends JPanel {
	...
	public PnWaveAttack(SendingArmy sendingArmy, int id, @SuppressWarnings("rawtypes") PriorityQueue pq) {
        lblMission = new JLabel();
        lblArrivalTime = new JLabel();
        lblMunition = new JLabel();
        lblUnit = new JLabel();
    ...
    private void addControl() {
        ...
        lblArrivalTime.setBounds(120, 10, 150, 35);
        lblArrivalTime.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblArrivalTime.setText("");
        lblMunition.setBounds(230, 10, 100, 35);
        lblMunition.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblMunition.setText("");
        lblUnit.setBounds(340, 10, 100, 35);
        lblUnit.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblUnit.setText("Test3");
        lblOrigin.setBounds(450, 10, 100, 35);
        lblOrigin.setFont(new Font("Tahoma", Font.PLAIN, 14));
        lblOrigin.setText("Test4");
        lblTarget.setBounds(560, 10, 100, 35);
        lblTarget.setFont(new Font("Tahoma", Font.PLAIN, 14));
        ...
        btnAction.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (sentArmy1 != null && sentArmy1.getRealArmy()!=null) {
                    ...
                    long finishTimeWave = System.currentTimeMillis() + Integer.parseInt((String)IsLandUI.cbbTimeWave.getSelectedItem())*1000;
                    javax.swing.Timer dongho = new javax.swing.Timer(1000, new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                        	lblArrivalTime.setText(ft.format(new Date(- System.currentTimeMillis() + finishTimeWave)));
                        }
                    });
                    dongho.start();
                    JOptionPane.showMessageDialog(null,"Thời gian wave: " +  ft.format(new Date(- System.currentTimeMillis() + finishTimeWave)));
                }
                else{
                    ...
                    timer.schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            JOptionPane.showMessageDialog(null, "Back Home Success");
                        }
                    }, System.currentTimeMillis() - sendingArmy.getStartTime());
                    
                    SimpleDateFormat ft = new SimpleDateFormat("mm:ss");
                    long finishTimebackhome = 2*System.currentTimeMillis() - sendingArmy.getStartTime();
                    javax.swing.Timer dongho = new javax.swing.Timer(1000, new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                        	lblArrivalTime.setText(ft.format(new Date(- System.currentTimeMillis() + finishTimebackhome)));
                        }
                    });
                    dongho.start();
                    JOptionPane.showMessageDialog(null,"Thời gian rút về: " + ft.format(new Date(- System.currentTimeMillis() + finishTimebackhome)));
                    
                    // đây không phải thời gian wave attack
                    // đây là thời gian khi mà chưa đi đến nhà địch đã đòi quay về => time về bằng time đi đến đoạn đi về
                }
            }
        });
    }
