...
//    public static boolean isGetOff = false;
    ...
    public void addControls() {
        ...
        lblTitle.setBounds(420, 0, 125, 20);
        ...
        pnMain.setPreferredSize(new Dimension(600, 1600));
        ...
        scDialog.setBounds(0, 50, 980, 530);//
        con.add(scDialog);
        ...
        pnMain2.setBounds(100, 1000, 810, 600);
        pnMain.add(pnMain2);
...
//});
        ...
        btnRun.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	for (Army.Unit unit : Army.Unit.values()) {
                    if (unit.ordinal() == 12) break;
                    if (pnSetUnitBattle[unit.ordinal()].getSld().getValue() != 0) {
                    	dispose();
...
//  				battleFieldFighting.setEnemyBattleField(battleField);
    ...
    private void saveArmyAndSentedArmy() {
        ...
        // sau khi có quân rồi mới cài đặt time di chuyển
        temp.setStartTime(System.currentTimeMillis());
        temp.setFinishTime((long) (temp.getStartTime()+ temp.getArmy().getSpeedTimeForWholeRoute()*1.0/Integer.parseInt((String)IsLandUI.cbbTimeGo.getSelectedItem())));
//        temp.setFinishTime(temp.getStartTime()+ 10000);
...
//		IsLandUI.myHouse.getSendingArmy().get(IsLandUI.currentHouse.getId()) = new ArrayList<Object>();
        ...
        // quân hàng 3 đi lạc khi không có hàng 1 và hàng 2
        temp.getArmy().getOff();
     ...
     public void setBattleField(Army.Unit unit) {
        switch (unit) {
            ...
            case Hoplite:
                ...
                int zz = battleField.setFrontLine();
                battleField.setFlankToSlot(false, zz);
            ...
            case SteamGiant:
                ...
                int xx = battleField.setFrontLine();
                battleField.setFlankToSlot(false, xx);
                pnBattlefield.updates(pnBattlefield.pnFront, 0);
                pnBattlefield.updates(pnBattlefield.pnFlank, 0);
                break;
            case Sulfur:
            ...
            case Swordsman:
                ...
                battleField.setFlankToSlot(false, y);
                pnBattlefield.updates(pnBattlefield.pnFlank, 0);
                pnBattlefield.updates(pnBattlefield.pnFront, 0);
                break;
            default:
