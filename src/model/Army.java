...
//        return army;
 //   }
    ...
    private boolean checkRow12() {
    	if (this.numberOfHop == 0 && this.numberOfSteam == 0 &&
    			this.numberOfSpear == 0 && this.numberOfSword == 0 &&
    			this.numberOfSlinger == 0 && this.numberOfArcher == 0 && this.numberOfSC == 0)
    		return false;
    	return true;
    }
    public void getOff() {
    	if (!this.checkRow12()) {
    		this.numberOfBB = 0;
    		this.numberOfGyrocopter = 0;
    		this.numberOfRam = 0;
    		this.numberOfMotar = 0;
    		this.numberOfCatapult = 0;
//    		BattleFieldUI.isGetOff = true;
    	}
    }
}
